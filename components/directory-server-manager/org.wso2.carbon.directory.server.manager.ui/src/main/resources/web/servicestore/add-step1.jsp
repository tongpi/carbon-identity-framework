                    ...
                    <td class="formRaw">
                        <table class="normal">
                            ...
                            <tr>
                                ...
                                <td><input type="password" name="password" value="" style="width:150px" autocomplete="off"/></td>
                            </tr>
                            <tr>
                                <td><fmt:message key="password.repeat"/><font
                                        color="red">*</font></td>
                                <td><input type="password" name="retype" value="" style="width:150px" autocomplete="off"/></td>
                            </tr>
                        </table>
                    </td>
                </tr>

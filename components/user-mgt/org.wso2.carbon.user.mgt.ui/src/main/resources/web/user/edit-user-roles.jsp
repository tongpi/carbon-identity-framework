...
<fmt:bundle basename="org.wso2.carbon.userstore.ui.i18n.Resources">
                    ...
                    <tr>
                        <td style="padding:0 !important">
                           <!--  <carbon:paginator pageNumber="<%=pageNumber%>"
                            ...
                            <input type="hidden" id="parametersCustom" value="<%="username="+Encode.forHtmlAttribute(decryptedUsername)%>">
 ...
 <script type="text/javascript">
        ...
        function doPaginate(obj, pageNumber){
            ...
            window.location.href="edit-user-roles.jsp?pageNumber=" + pageNumber +"&" + dataParametersCustom;
        }        

...
<fmt:bundle basename="org.wso2.carbon.userstore.ui.i18n.Resources">
    ...
    <div id="middle">
        ...
        <div id="workArea">
            ...
            <form method="post" action="edit-users-finish-ajaxprocessor.jsp?viewUsers=true" onsubmit="return doValidation();"
                ...
                <input type="hidden" id="parametersCustom" value="<%="roleName="+Encode.forHtmlAttribute(roleName)%>">
 ...
 <script type="text/javascript">
        ...
        function doPaginate(obj, pageNumber){
            ...
            window.location.href="view-users.jsp?pageNumber=" + pageNumber +"&" + dataParametersCustom;
        }        
